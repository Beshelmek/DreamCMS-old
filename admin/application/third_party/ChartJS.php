...
abstract class ChartJS
{
    ...
    public function __construct($id = null, $width = '', $height = '', $otherAttributes = array(), $chartOptions = array())
    {
        if (!$id) {
        ...
        // Always save chartOptions as array
        if ($chartOptions && !is_array($chartOptions)) {
    ...
    public function renderCanvas()
    {
        ...
        $canvas = '<canvas class="chart" id="' . $this->_id . '" data-chartjs="' . strtolower($this->_type) . '"' . $height . $width . $attributes . $data . $options . '></canvas>';
